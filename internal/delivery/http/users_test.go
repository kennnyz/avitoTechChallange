...
func TestAddUserToSegment(t *testing.T) {
	...
	testTable := []struct {
		...
		},
		{
			...
			expectedBody:       `{"userid":1000,"segments_to_adding":["segment1","segment2"],"segments_to_delete":["segment3"]`,
			expectedMethod:     http.MethodPost,
			path:               "/add-user-to-segment",
		},
		{
		...
		},
		{
			...
			expectedStatusCode: 400,
			expectedResponse:   `{"message":"invalid json"}`,
			expectedBody:       `{"userid":asd,"segments_to_add":["segment1","segment2"],"segments_to_delete":["segment3"]}`,
			expectedMethod:     http.MethodPost,
			path:               "/add-user-to-segment",
		},
		{
		...
		},
		{
			...
			expectedStatusCode: 400,
			expectedResponse:   `{"message":"bad user id"}`,
			expectedBody:       `{"userid":-1,"segments_to_add":["segment1","segment2"],"segments_to_delete":["segment3"]}`,
			expectedMethod:     http.MethodPost,
			path:               "/add-user-to-segment",
		},
	}
